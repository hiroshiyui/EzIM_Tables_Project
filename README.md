...
- `make_ez_keyboard.rb` — 將 `ez_root_images/` 套入 `qwerty_keyboard_template.svg`，產生標註字根的 `ez_keyboard_images/ez_keyboard.svg` 與 `ez_keyboard_images/ez_keyboard_plain.svg`
